FUNCTION READ_XML8_pp,filename=filename,string=string, outFile=outFile, validation = validation
;+
; NAME:
;	READ_XML8	
;
...
;-----------------------------------------------------------------
  ...
  oDoc = OBJ_NEW('IDLffXMLDOMDocument', FILENAME=filename,string=string,$
